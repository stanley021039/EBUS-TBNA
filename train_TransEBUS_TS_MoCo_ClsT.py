...
parser.add_argument("--save_dir", default='savemodel221014_TransEBUS_TS_MoCo_clsT', type=str, help="assign save folder")
...
if is_testing:
    ...
    test_loss, test_Acc_video, test_Acc_lesion, test_auc_video, test_auc_lesion = test(epoch, TestingLoader,
                                                                                       encoder,
                                                                                       loss_fn)
    print('test loss : %.4f' % test_loss, 'test Acc : %.2f' % test_Acc_lesion, 'test AUC : %.4f' % test_auc_lesion, file=f)
