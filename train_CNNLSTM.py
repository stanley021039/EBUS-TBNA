...
model = nn.DataParallel(CNNLSTM(num_classes=number_classes, init_weights=True), device_ids=[0, 1])
model.to(device)
...
if is_training:
    ...
    ValidationDataset = Dataset3D('data/raw_video', 'data_lesion_0524.xlsx', 'data/two_stream_data_old/UD_clip', doppler=True, elastography=False,
                                  ...
                                  UD_reconstruct=False, E_reconstruct=False, resize=(224, 224), UD_shape='THWC')
