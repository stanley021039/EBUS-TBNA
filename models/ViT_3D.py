...
class ViT(nn.Module):
    def __init__(self, *, image_size, patch_size, num_classes, dim, depth, heads, mlp_dim, pool='cls', channels=3,
        ...
        self.to_patch_embedding = nn.Sequential(
            Rearrange('b c (h p1) (w p2) (t p3) -> b (h w t) (p1 p2 p3 c)', p1=patch_height, p2=patch_width, p3=patch_depth),
    ...
    def forward(self, img_3D):
        x = self.to_patch_embedding(img_3D)
        b, n, _ = x.shape
        ...
        x = self.to_latent(x)
        return self.out_act(self.mlp_head(x))
