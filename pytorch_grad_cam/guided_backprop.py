...
class GuidedBackpropReLUModel:
    ...
    def forward(self, input_img_1, input_img_2):
        return self.model(input_img_1, input_img_2)[0]
    ...
    def __call__(self, input_img, target_category=None):
        ...
        input_img_1 = input_img[0].requires_grad_(True)
        input_img_2 = input_img[1].requires_grad_(True)

        output = self.forward(input_img_1, input_img_2)
        ...
        output = input_img_1.grad.cpu().data.numpy()
        print('GuidedBackpropReLUModel_output', output.shape)
        output = output[0, :, :, :, 0]
